...
<script id="product-item" type="text/x-handlebars-template">
    <ul class="breadcrumb">
        ...
        <li><a href="${pageContext.request.contextPath}/brand/{{brand.id}}">{{brand.title}}</a> <span
                class="divider">/</span></li>
        <li><a href="${pageContext.request.contextPath}/category/{{category.id}}">{{category.title}}</a> <span
                class="divider">/</span></li>
        <li>{{title}}</li>
    </ul>
        ...
        <div class="row-fluid">
            ...
            <div class="span8">
                ...
                <div id="product-addcart" class="row-fluid span10">
                    ...
                    <div class="span4">
                        <a class="btn btn-block span4"><i class="icon-shopping-cart"></i><br>В корзину</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="pdoduct-allphoto">
        <a href="/resources/img/80137.jpg" class="image-zoom" title="MYTITLE">
            <img src="/resources/img/assets_images_FANTAZIA_57_1.jpg.ce19723794696a7d450fc4850919c696.jpg" title="IMAGE TITLE">
        </a>
    </div>
</script>