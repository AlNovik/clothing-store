            ...
            <div class="row-fluid">
                ...
                <div class="span5">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select class="span12" id="category">
                                <option>Выбрать</option>
                            </select>
                            <span class="help-block"></span>
                        </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <label class="checkbox inline">
                        <input type="checkbox" id="size_36" value="option1"> 36
                    </label>
                    <label class="checkbox inline">
                        <input type="checkbox" id="size_38" value="option2"> 38
                    </label>
                    <label class="checkbox inline">
                        <input type="checkbox" id="size_40" value="option3"> 40
                    </label>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <label class="checkbox inline">
                        <input type="checkbox" id="height_162" value="option1"> 162
                    </label>
                    <label class="checkbox inline">
                        <input type="checkbox" id="height_170" value="option2"> 170
                    </label>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-append">
                        <input class="span10" id="price" size="16" type="number"><span class="add-on">.руб</span>
                    </div>
                </div>
            </div>
            <div class="row-fluid">
