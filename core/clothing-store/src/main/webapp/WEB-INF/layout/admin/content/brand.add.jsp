...
<div class="modal hide fade modal-admin" id="modal-brand-add" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3>Добавить новый бренд</h3>
    </div>
    <form class="form-horizontal well" id="newBrand">
        <div class="modal-body well">
            <div class="row-fluid">
                <div class="span9">
                    <div class="control-group">
                        <input class="span12" type="text" placeholder="Название" name="title">
            ...
            <div class="row-fluid">
                <div class="span6">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="span3">/brand/</label>
                            <input type="text" class="offset3 span9" id="url-brand" name="properties.url">
                        </div>
                    </div>
                    <div class="control-group">
